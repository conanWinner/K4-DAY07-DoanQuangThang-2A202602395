...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Split sentences while preserving punctuation using lookbehind
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Recursively process pieces that are too large
        ...
        # Merge smaller adjacent pieces back up to chunk_size
        merged: list[str] = []
        current_chunk = ""
        for s in processed_splits:
            if not current_chunk:
                ...
                candidate = f"{current_chunk}{sep}{s}"
